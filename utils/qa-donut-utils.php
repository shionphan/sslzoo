<?php
    ...
    function donut_generate_social_links()
    {
        ...
        $social_links = array(
            'weibo'    => array(
                'icon'       => 'weibo',
                'text'       => donut_lang( 'weibo' ),
                'hover-text' => donut_lang( 'follow_us_on_x', donut_lang( 'weibo' ) ),
            ),
            'wechat'     => array(
                'icon'       => 'wechat',
                'text'       => donut_lang( 'wechat' ),
                'hover-text' => donut_lang( 'follow_us_on_x', donut_lang( 'wechat' ) ),
            ),
            'email'       => array(
                'icon'       => 'envelope',
