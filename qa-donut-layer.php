<?php
    ...
    class qa_html_theme extends qa_html_theme_base
    {
        ...
        function donut_default_meta()
        {
            ...
            $this->output_raw('<meta http-equiv="X-UA-Compatible" content="IE=edge">');
            $this->output_raw('<meta name="viewport" content="width=device-width, initial-scale=1">' );
            $this->output_raw('<meta name="description" content="SSLZOO是专业的SSL技术分享平台，提供专业的SSL技术指导、优惠的全球认证SSL证书、开源问答Q2A的技术交流和模板分享" />');
            $this->output_raw('<meta name="keywords" content="ssl,ssl证书,https,EV证书,DV证书,通配符证书,q2a,开源问答,https123" />');

            $this->output_raw('<link rel="shortcut icon" href="./qa-theme/sslzoo/favicon.ico" type="image/x-icon" />');
        }
        ...
        function head_css()
        {
            ...
            $css_paths = array(
                'fonts'     => 'css/font-awesome.min.css?4.5.0',
                'icon'     => 'css/icon.css',
                'bootstrap' => 'css/bootstrap.min.css?3.3.6',
                'bootstrap-select' => 'css/bootstrap-select.min.css?1.10.0',
                'highlight' => 'css/highlight.zenburn.css?1.0.0',
                //'donut'     => 'css/sslzoo.css?' . DONUT_THEME_VERSION,
            );

            if ( qa_opt( 'donut_activate_prod_mode' ) ) {
                $cdn_css_paths = array(
                    'fonts'     => Donut_Option_Keys::FA_CDN,
                    'icon'     => Donut_Option_Keys::ICON_CDN,
                    'bootstrap' => Donut_Option_Keys::BS_CSS_CDN,
                    'bootstrap-select' => Donut_Option_Keys::BS_SLTCSS_CDN,
                    'highlight' => Donut_Option_Keys::HGT_CSS_CDN,
                    //'donut'     => 'sslzoo/css/sslzoo.css?' . DONUT_THEME_VERSION,
                );
                ...
                //$css_paths['donut'] = 'css/sslzoo.css?' . DONUT_THEME_VERSION;  //put the donut.min.css for the prod mode
            }
            ...
            $this->output_raw( '<link rel="stylesheet" type="text/css" href="/qa-theme/sslzoo/css/sslzoo.css?">');
        ...
        function donut_utility_for_old_ie()
        {
            $this->output( '
    			<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    			   <!--[if lt IE 9]>
    			     <script src="/qa-theme/sslzoo/js/respond.min.js"></script>
    			<![endif]-->
    		');
        }
        ...
        function head_script() // change style of WYSIWYG editor to match theme better
        {
            ...
            $js_paths = array(
                'bootstrap' => 'js/bootstrap.min.js?3.3.6',
                'bootstrap-select' => 'js/bootstrap-select.min.js?1.10.0',
                'highlight' => 'js/highlight.pack.js?9.2.0',
            ...
            if ( qa_opt( 'donut_activate_prod_mode' ) ) {
                $cdn_js_paths = array(
                    ...
                    'bootstrap-select' => Donut_Option_Keys::BS_SLTJS_CDN,
                    'highlight' => Donut_Option_Keys::HGT_JS_CDN,
                    //'donut'     => 'js/donut.js?' . DONUT_THEME_VERSION,
                );
            ...
            $this->output_raw('<script src="/qa-theme/sslzoo/js/donut.js?1.6.2"></script>');
        ...
        function main()
        {
            ...
            $this->output( '<div class="qa-main-l clearfix">' );
            ...
            $this->output( '<div class="qa-main-parts clearfix">' );
        ...
        function donut_sidebar_toggle_nav_btn()
        {
            ...
            $this->output( '<div class="visible-xs side-toggle-button">' );
        ...
        function feed()
        {
            ...
            if ( !empty( $feed ) ) {
                $icon = donut_get_fa_icon( 'fa fa-rss' );
        ...
        function body_suffix() // to replace standard Q2A footer
        {
            ...
            $this->output( '<div class="donut-footer">' );
            ...
            <div id="nav-header">
                <div id="nav" class="navbar navbar-static-top"
                    ...
                    <div class="container">
                        ...
                        <div class="donut-navigation pull-right">
        ...
        function a_selection( $post )
        {
            ...
            elseif ( $post['selected'] )
                $this->output( '<div class="qa-a-selected"> <span class="icon icon-best"></span> </div>' );
        ...
        {
            $avatar = donut_get_post_avatar( $q_item, 64 );
        ...
        {
            if ( isset( $tags ) ) {
                $icon = donut_get_fa_icon( 'fa fa-heart' );
        ...
        function attribution()
        {
            ...
            $this->output( '<div class="footer-bottom clearfix">' );
        ...
        function ranking( $ranking )
        {
            ...
            if ( @$ranking['type'] == 'users' ) {
                $this->output('<h2>'. qa_lang_html_sub( 'main/nav_users', qa_html( $nav_users ) ) .'</h2>');
                ...
                $this->output('<h2>'. qa_lang_html_sub( 'main/nav_tags', qa_html( $nav_tags ) ) .'</h2>');
                if ( count( $ranking['items'] ) ) {
        ...
        private function donut_attribution()
        {
            /* $this->output(
                    ...
                    '服务器平台：Aliyun <a href="http://s.click.taobao.com/t?e=m%3D2%26s%3Djk0oig4pJp0cQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAlWrR%2FGnQMW4Zww6RT0J%2BfYS5SdbgmdqJBGpNt6Ry87gBOy9at1thse%2B%2Ff%2FRgFUKdedn1BbglxZYxUhy8exlzcpAFEHVckI7b3VyxRO0gvF4QxJtmCgOmCLZ%2FNxlvga2vCGHCdjJcucegWK9VBnTRuNlDnA5T%2FnLesYOae24fhW0" target="_blank"><span class="fa fa-server"></span> ESC</a> + <a href="http://s.click.taobao.com/t?e=m%3D2%26s%3DgYZYMtrKT4scQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAlWrR%2FGnQMW4ikSuMzYqMlQS5SdbgmdqJBGpNt6Ry87gBOy9at1thse%2B%2Ff%2FRgFUKdedn1BbglxZYxUhy8exlzcq9AmARIwX9K%2BnbtOD3UdznPV1H2z0iQv9NkKVMHClW0R0UfDzlkg%2B9vjQXzzpXdTHGJe8N%2FwNpGw%3D%3D" target="_blank"><span class="fa fa-database"></span> RDS</a>',
                    '</div>'
            ); */
        }
        ...
        private function donut_copyright()
        {
            $this->output(
                    ...
                    '<a href="http://www.miitbeian.gov.cn" target="_blank">皖ICP备17001055号-1</a>',
                    '</div>'
            );
        }
        ...
        private function donut_generate_action_button( $action_view, $btn_style = 'vertical' )
        {
            ...
            $this->output( '<button type="button" class="qa-form-light-button dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="更多操作">' );
